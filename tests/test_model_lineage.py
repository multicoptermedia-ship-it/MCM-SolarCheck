...
def test_training_run_id_is_reproducible_and_parameter_sensitive():
    a=TrainingRun("d"*64,"s"*64,"ultralytics","8.3","rendered_rgb",{"epochs":50,"imgsz":640})
    b=TrainingRun("d"*64,"s"*64,"ultralytics","8.3","rendered_rgb",{"imgsz":640,"epochs":50})
    assert a.run_id==b.run_id
    c=TrainingRun("d"*64,"s"*64,"ultralytics","8.3","rendered_rgb",{"epochs":51,"imgsz":640})
